...
export default async function portfolioRoutes(fastify: FastifyInstance) {
  ...
  fastify.post(
    "/social/sync-stats",
    { preValidation: [fastify.authorizeDeveloper] },
    PortfolioController.syncSocialStats,
  );
  fastify.get(
    "/export",
    { preValidation: [fastify.authorizeDeveloper] },
    PortfolioController.exportData,
  );
  ...
  fastify.post(
    "/projects/bulk",
    { preValidation: [fastify.authorizeDeveloper] },
    PortfolioController.bulkUpdateProjects,
  );
  fastify.put(
    "/projects/:id",
    { preValidation: [fastify.authorizeDeveloper] },
  ...
  fastify.post(
    "/experiences/bulk",
    { preValidation: [fastify.authorizeDeveloper] },
    PortfolioController.bulkUpdateExperiences,
  );
  fastify.put(
    "/experiences/:id",
    { preValidation: [fastify.authorizeDeveloper] },
  ...
  fastify.post(
    "/certificates/bulk",
    { preValidation: [fastify.authorizeDeveloper] },
    PortfolioController.bulkUpdateCertificates,
  );
  fastify.put(
    "/certificates/:id",
    { preValidation: [fastify.authorizeDeveloper] },
  ...
  fastify.delete(
    "/certificates/:id",
    { preValidation: [fastify.authorizeDeveloper] },
    PortfolioController.deleteCertificate,
  );
  ...
  fastify.post(
    "/services",
    { preValidation: [fastify.authorizeDeveloper] },
    PortfolioController.createService,
  );
  fastify.post(
    "/services/bulk",
    { preValidation: [fastify.authorizeDeveloper] },
    PortfolioController.bulkUpdateServices,
  );
  fastify.put(
    "/services/:id",
    { preValidation: [fastify.authorizeDeveloper] },
  ...
  fastify.delete(
    "/services/:id",
    { preValidation: [fastify.authorizeDeveloper] },
    PortfolioController.deleteService,
  );
  ...
  fastify.post(
    "/testimonials",
    { preValidation: [fastify.authorizeDeveloper] },
    PortfolioController.createTestimonial,
  );
  fastify.post(
    "/testimonials/bulk",
    { preValidation: [fastify.authorizeDeveloper] },
    PortfolioController.bulkUpdateTestimonials,
  );
  fastify.put(
    "/testimonials/:id",
    { preValidation: [fastify.authorizeDeveloper] },
  ...
  fastify.delete(
    "/testimonials/:id",
    { preValidation: [fastify.authorizeDeveloper] },
    PortfolioController.deleteTestimonial,
  );
  ...
  fastify.post(
    "/education/bulk",
    { preValidation: [fastify.authorizeDeveloper] },
    PortfolioController.bulkUpdateEducation,
  );
  fastify.put(
    "/education/:id",
    { preValidation: [fastify.authorizeDeveloper] },
