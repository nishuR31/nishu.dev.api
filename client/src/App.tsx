  ...
  return (
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)] transition-colors duration-200">
      ...
      {!isLoginPage && mobileMenuOpen && (
        <div
          className="md:hidden fixed inset-0 top-[57px] z-40 bg-black/60 backdrop-blur-sm"
          onClick={() => setMobileMenuOpen(false)}
        >
          <div
            className="glass-panel border-b border-[var(--border)] shadow-2xl animate-in slide-in-from-top-2 duration-200 max-h-[70vh] overflow-y-auto"
